...
- Preview decomposition has started with an explicit CommCell preview partial, proving the extraction pattern before applying it to the more complex subject previews.
