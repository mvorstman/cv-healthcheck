...
- Preview decomposition has started with explicit CommCell and Security Assessment preview partials, proving the extraction pattern before applying it to the remaining subject previews.
